...
function temperatureConverterCelToFar(valNum) {
...
function LengthConverter44(valNum) {

    document.getElementById("outputMeters44").innerHTML = valNum *2.59;
}
function clearOutput44() {
    document.getElementById("inputFeet44").value = "0"; 
    LengthConverter44(""); 
}

//Acres to Hectares

function LengthConverter36(valNum) {

    document.getElementById("outputMeters36").innerHTML = valNum *2.59;
}
function clearOutput36() {
    document.getElementById("inputFeet36").value = "0"; 
    LengthConverter36(""); 
}
